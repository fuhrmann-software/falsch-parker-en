      ...
      <div className='relative flex h-[700px] w-full overflow-hidden rounded-bl-card rounded-tl-card rounded-tr-card max-lg:hidden'>
        <div className='absolute z-[2] flex h-full flex-col justify-center pl-[100px] pr-[50px] text-2xl text-dark max-xl:w-[50%] lg:w-[50%] xl:w-[60%]'>
          ...
          <span className='text-xl max-xl:text-lg max-sm:text-base'>
            We offer our customers in Lausanne a comprehensive towing service
            ...
            equipment to remove illegally parked vehicles quickly and safely. We
            work closely with our customers to ensure that their parking spaces
            are always accessible and that they do not have to tolerate
          ...
          <div className='flex h-[760px] w-full  items-center justify-center rounded-card bg-white px-10 max-md:h-[580px] max-md:w-full'>
            <div className='flex flex-col justify-between py-5 text-2xl text-dark'>
              ...
              <span className='text-xl max-sm:text-base'>
                We offer our customers in Lausanne a comprehensive towing
                service and compensation for illegal parking on private
                property. Our team of experienced towing specialists is equipped
                with the latest equipment to remove illegally parked vehicles
                quickly and safely. We work closely with our customers to ensure
                that their parking spaces are always accessible and that they do
                not have to tolerate unauthorized parking visitors.
              </span>
            </div>
          </div>
        ) : (
